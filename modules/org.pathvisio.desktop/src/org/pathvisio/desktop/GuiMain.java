...
*/	
	private void setGdbStatus(JLabel allLabel) {
		...
		if (swingEngine.getGdbManager().getGeneDb() == null && swingEngine.getGdbManager().getMetaboliteDb() == null && swingEngine.getGdbManager().getInteractionDb() == null) {
			...
			allLabel.setText(" | Local mapping databases loaded: " + "GeneProtein: " + shortenString(gdb) + " and " + "Metabolite: " + shortenString(mdb));
		}
		else if (swingEngine.getGdbManager().getGeneDb() == null && swingEngine.getGdbManager().getMetaboliteDb() != null && swingEngine.getGdbManager().getInteractionDb() != null) {
			allLabel.setText(" | Local mapping databases loaded: " + "Metabolite: " + shortenString(mdb) + " and " + "Interactions: " + shortenString(idb));
		}
		else if (swingEngine.getGdbManager().getGeneDb() != null && swingEngine.getGdbManager().getMetaboliteDb() == null && swingEngine.getGdbManager().getInteractionDb() != null) {
			allLabel.setText(" | Local mapping databases loaded: " + "GeneProtein: " + shortenString(gdb) + " and " + "Interactions: " + shortenString(idb));
		}
		else {
		     allLabel.setText(" | Local mapping databases loaded: " + "GeneProtein: " + shortenString(gdb) + " and " + "Metabolite: " + shortenString(mdb) + " and " + "Interactions: " + shortenString(idb));
		}
